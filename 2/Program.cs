...
Console.WriteLine($"Ingrese una fila para mostrar (0 - {filas-1})");
Console.WriteLine();
while (!int.TryParse(Console.ReadLine(), out buscar) || buscar<0 || buscar>=filas)
{
    Console.WriteLine();
    Console.WriteLine("Dato no válido");
    Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Los números en esa fila son: ");
Console.WriteLine();
for  (int i = 0; i < columnas; i++)
{
    Console.Write(numeros[buscar, i] + " ");
}
Console.WriteLine();